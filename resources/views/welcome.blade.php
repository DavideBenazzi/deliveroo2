            ...
            <div class="main-section container d-flex flex-col just-around">
                ...
                <div id="advancedSearch-box">
                    <div class="wrapper p-relative">
                        <div class="icon-box">
                            <a href="{{ route('advancedResearch') }}"><i class="fas fa-search"></i></a>
                        </div>
                        <div class="hover-icon">
                            <a id="slide-right" href="{{ route('advancedResearch') }}">Do you already know the restaurant? Click there and find it.</a>
                        </div>
                    </div>
                </div>
            </div>
